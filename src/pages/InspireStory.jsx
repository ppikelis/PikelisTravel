...
import { getInspireStoryGeoLabel, getInspireStoryGuideUrl, getInspireStoryHeroAlt } from "../utils/inspireStoryDisplay.js";
...
export default function InspireStoryPage() {
  ...
  const geoLabel = story ? getInspireStoryGeoLabel(story.metadata || {}) : "";
  const guideHref = story ? getInspireStoryGuideUrl(story.metadata || {}) : "";
  ...
  const heroAlt = story ? getInspireStoryHeroAlt(story) : "Story";
